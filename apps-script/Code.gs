...
function doPost(e) {
  ...
  sheet.appendRow([
    ...
    number_(values.incoming),
    number_(values.answered),
    number_(values.cancellations),
    number_(values.serviceSales),
...
function rowToSubmission_(row) {
  return {
    ...
    values: {
      ...
      incoming: number_(row.incoming),
      answered: number_(row.answered),
      cancellations: number_(row.cancellations),
      serviceSales: number_(row.serviceSales),
